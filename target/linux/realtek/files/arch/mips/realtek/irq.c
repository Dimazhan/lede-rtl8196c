...
static void __init rtl819xd_irq_init(void)
{
	mips_chip_bits = RTL819XD_INTCTL_IRQ_TC0/* | RTL819XD_INTCTL_IRQ_TC1 | RTL819XD_INTCTL_IRQ_SWCORE*/ |
		RTL819XD_INTCTL_IRQ_UART0 | RTL819XD_INTCTL_IRQ_USB | RTL819XD_INTCTL_IRQ_PCIE | RTL819XD_INTCTL_IRQ_PCIE2 |
		RTL819XD_INTCTL_IRQ_PCI/* | RTL819XD_INTCTL_IRQ_GPIO_ABCD | RTL819XD_INTCTL_IRQ_GPIO_EFGH*/;
	...
	__raw_writel(
		RTL819XD_INTCTL_RS_GPIO_ABCD << RTL819XD_INTCTL_IRR1_GPIO_ABCD_SHIFT |
		RTL819XD_INTCTL_RS_GPIO_EFGH << RTL819XD_INTCTL_IRR1_GPIO_EFGH_SHIFT |
		RTL819XD_INTCTL_RS_PCIE << RTL819XD_INTCTL_IRR1_PCIE_SHIFT |
		RTL819XD_INTCTL_RS_PCIE2 << RTL819XD_INTCTL_IRR1_PCIE2_SHIFT,
		realtek_intctl_base + REALTEK_INTCTL_REG_IRR2);
}
...
static void __init realtek_soc_irq_init(void)
{
	...
	/*for (i = MIPS_CPU_IRQ_BASE + 2; i < MIPS_CPU_IRQ_BASE + 8; i++)
